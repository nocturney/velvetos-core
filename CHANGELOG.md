...
See **Unreleased** for **vfcanva** (Canva Instagram desk; HQ-native), **The Agency** (273 Cursor specialists), **vfmcp** (MCP fit research; HQ-native), **vfe2b** (awesome-ai-agents desk; HQ-native), **vfmakers** (makerskills desk; HQ-native), and **vfagents** (500-list playbooks; HQ-native).
