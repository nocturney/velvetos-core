...
- 2026-08-30 — **vfcanva**: `spawn git ENOENT` = תוסף המרקטפלייס בלי Git ב־PATH; לעקוף עם URL בפרויקט. Marketplace plugin fails without Git; use project `url` MCP instead. See `packages/vfcanva/CONNECT.md`.
