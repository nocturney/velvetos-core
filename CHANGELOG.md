...
- 2026-08-30 — **vfcanva**: תוסף מקומי (`vf-canva`, HTTP MCP, בלי Git) + סטודיו שמייצר PNG 1080. Local plugin (no marketplace git) + studio PNG renderer. Uninstall the broken marketplace Canva plugin.
