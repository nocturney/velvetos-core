...
- 2026-08-31 — **3D AI Studio MCP**: `3daistudio` HTTP server at `https://mcp.3daistudio.com/mcp` in `.cursor/mcp.json`. Desk `threedaistudio` on production seat. Playbooks `vfprod/CONNECT-3DAI.md` + `3DAISTUDIO.md`. OAuth Desktop only; no API key in git.
