...
- 2026-08-30 — **תזמורת**: פלייבוק 06:15 + שני מעברים. מנוי: Product Lab, כרטיס פנייה, ביו בלי הבטחת מחיר. Perplexity נתן 3 כיווני מק״ט; 4–7 נחתכו ולא הומצאו. See `constitution/ORCHESTRA.md`, `docs/ORCHESTRA-2026-08-30.md`.
...
See **Unreleased** for **vfmcp** (MCP fit research; HQ-native).
