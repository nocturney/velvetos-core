...
- 2026-08-30 — **vfcanva**: מדריך החזרת Canva לרשימה (קישור התקנה + Add Custom MCP). How to add Canva back after uninstalling the marketplace plugin. See `packages/vfcanva/CONNECT.md`.
