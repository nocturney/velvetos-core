...
HQ-native research packs (not Origin trees): `vfmcp` ([`docs/MCP-FIT.md`](../docs/MCP-FIT.md)), `vfe2b` (e2b-dev/awesome-ai-agents desk), `vfmakers` ([`docs/MAKERSKILLS-EMBED-he.md`](../docs/MAKERSKILLS-EMBED-he.md)), and `vfagents` ([`docs/500-AGENTS.md`](../docs/500-AGENTS.md)).
