...
> LEGACY / provenance only for VF publication; not a provider route: Instagram -> Canva ראשון -> image tools / Superdesign failover. להכין 3 cover directions ולבחור אחת לפי Visual OS + grid continuity. אין brand hex/font מומצא.
