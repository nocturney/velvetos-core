...
### 2026-09-14 (מבנה ההצעה — תיקון בעלים)

- **מושב:** lead + תפעול + צמיחה
- **למדנו:** ההצעה לציבור כוללת מוצרים מוכנים והדפסה / מודל בהתאמה אישית. סוג הלקוח וכמות היחידות הם מאפייני הזמנה בלבד ואינם קטגוריית שירות או עמודת שיווק.
- **מחר:** להסיר ניסוחים ישנים מכל מקור פעיל, ביו, קופי, בריף ו־router; הזמנה של כמה יחידות מתוארת בכמות הקונקרטית שלה בלבד.
- **מקור:** תיקון בעלים 14.9.2026 · `packages/vfbiz/OFFERING.md` · `constitution/STUDIO.md`.
