...
### 2026-09-05 (G003 שדרוג SoccerBall)
- **מושב:** צמיחה
- **למדנו:** כריסטיאן אישר להחליף נתיב מדפסת ב־SoccerBall המקומי. הכיתוב נשאר «מה יוצא מהמדפסת?» (לא בלוק הכדור). מדפסת = נפילה. סטודיו חותך ומחליף את המדיה המשובצת.
- **מחר:** לא להעלות mp4 לגיט. לא לפרסם מ־HQ.
- **מקור:** החלטת כריסטיאן 5.9.
