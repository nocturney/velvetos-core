...
| Cloud Agent: גוגל «You're already signed in on another device or browser» | דפדפן הסוכן = מכשיר חדש. **מיד** WebSearch + פקים. לראש צוות: אחרי 48 שעות קישור ב־`nocturney@gmail.com` (גם ספאם) «help you sign in here». חשבון: אותו גוגל. אין סיסמה בצ׳אט. אין Flash-Lite אורח. |
| כלי אחד הצליח ואחר לא | מטמיעים רק מגוף אמיתי. failover לשולחן שעובד. |
| שלושתם נפלו | «אין חדש במשרד» רק אם גם אין הטמעה מ-WebSearch/פקים + הסלמה על חומות. בלי גוף מומצא. |
