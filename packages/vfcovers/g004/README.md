# VF-G004 stories — vfcovers pass

Local luxury compose for the 7.9.2026 locked Stories rebuild. Canva MCP remains the live visual tool; this folder is the second evidence pass.

Rebuild:

```bash
python3 packages/vfcovers/g004/compose_stories.py
```
