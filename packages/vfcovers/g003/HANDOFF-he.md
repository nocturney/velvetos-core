...
- כיתוב «כדור» / `vfcopy/G003.md` — כריסטיאן השאיר alt-1.
- G001/G002 מקורות לריל חדש בלי אישור.
- המצאת mp4 / העלאת בינארי לגיט.

## כיתוב משובץ — G003-alt חלופה 1

מקור: `packages/vfcopy/G003-alt.md`. להשאיר גם ב־`VF-G003-caption.txt`.
...
## סטילים בספרייה (לא G003)

IMG_0421, 0434, 0587, 0686, 0784 (תמנון), 0821, 0826, 0844, 0861(1), 0899, 0901 + כריכות G001/G002.

## מה דולג

- לטעון שעלה לפיד
- Meta Suite / בוסט / «שלחו DM»
