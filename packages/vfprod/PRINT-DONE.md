...
- תחזוקה אחרי ההדפסה (דיזה / שימון / פילטר): כן / דלג / חסר (`MAINTENANCE.md`)
...
| 3 כיתוב | סטודיו/צמיחה | `vfcopy` + `VOICE.md` | כיתוב + CTA הודעת Instagram | לא «שלחו DM»; לא וואטסאפ בכיתוב; לא ₪ מומצא |
