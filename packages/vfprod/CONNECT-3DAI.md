...
המתג **לא** ב-Marketplace / Plugins. שם השרת ב-Cursor חייב `threedaistudio` (לא `3daistudio` — Cursor מדלג על מפתח שמתחיל בספרה).
...
| Marketplace / Plugins | אין תוסף חנות. זה HTTP ב-`mcp.json` |
