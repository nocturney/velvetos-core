...
לוח קבוע: `vfgrowth/CALENDAR.md`. G003 נעול ב־`G003.md`. G004 מחזיק-קטלבל ב־`G004.md`. סטוריז: `hq/templates/ig-stories.md` (CTA היילייטס+וואטסאפ). שיבוץ ב־instagram.com. רואים `hq/PLAYBOOK.md`.
