...
מגישים ל־`#vfsales` ו־`#vfgrowth`. לוח קבוע: `vfgrowth/CALENDAR.md`. כיתוב G003 + G003-alt + תבנית סטוריז ב־`hq/templates/ig-stories.md`. שיבוץ ב־instagram.com. רואים `hq/PLAYBOOK.md`.
