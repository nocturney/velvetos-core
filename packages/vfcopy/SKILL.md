...
מגישים ל־`#vfsales` ו־`#vfgrowth`. לוח קבוע: `vfgrowth/CALENDAR.md`. G003 נעול ב־`G003.md`. סטוריז: `hq/templates/ig-stories.md` (CTA היילייטס+וואטסאפ). שיבוץ ב־instagram.com. רואים `hq/PLAYBOOK.md`.
