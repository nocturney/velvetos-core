...
| **אילוצים** | `VOICE.md` · CTA אחד · בלי ₪ · בלי «שלחו DM» עירום · בלי דדליין לפני `#vfprod` |
...
- כיתוב IG: קודם `VOICE.md` — **תהליך-קצר** (הוק + שכבות + עקבו לשבוע הבא) או **סיפור-מוצר** (הכירו / מתאים כ / הודעה באינסטגרם או וואטסאפ + `050-2517000` + איסוף). האשטאגים 4–6, בלי ספאם  
- בלי פתיחה ב«מוכנים» / «בלי משלוח». בלי קופי דק כמו G004 המוקדם («חמש ורודות מהמיטה»)  
