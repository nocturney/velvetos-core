...
פריפלייט כתוב (חובה): [`PREFLIGHT.md`](PREFLIGHT.md) — VOICE + ציון עצמי + 2–3 קומפס. בלי ארטיפקט `preflight/<id>.md` = **נכשל-סגור**.

**אסור** לשבץ או לפרסם JPEG גולמי עם טקסט מעליו בלבד (טקסט-על-קובץ-רצפה).  
**חובה** לעבור כלי עריכה אמיתי **ו** בדיקת `VOICE.md`. בלי קישור עריכה / PNG מורכב = **לא משבצים**.  
