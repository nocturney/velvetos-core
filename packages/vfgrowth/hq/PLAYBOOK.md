...
**ריל:** Hook · טקסט על הסרטון · Caption · CTA הודעת Instagram / איסוף  

**סטורי (טיוטה לסקירה, לא צפייה אוטומטית):**  
1. «נחשו מה מדפיסים היום» — רק אם אין ספוילר ללקוח פרטי  
2. Timelapse  
3. תוצאה  
4. «רוצים בהתאמה? שלחו לנו הודעה כאן באינסטגרם · היילייטס בפרופיל · איסוף שדרות»  
...
שבוע ג׳אב/הוק: `@vfmakers rotation` → `hq/rotation/`. הוק = שלחו לנו הודעה כאן באינסטגרם / איסוף שדרות (`PUBLIC_CURRENT_CTA`). HQ לא שולח.
