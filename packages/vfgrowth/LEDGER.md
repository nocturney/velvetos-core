...
|---|---|---|---|---|---|
| VF-G003 | ריל תהליך/גילוי · ריל #3 | SoccerBall (שם מכריסטיאן) | **חסר** — חיפוש Drive משרדי 5.9 בלי קליפ רצפה; לא משתמשים בתיקיות אישיות | טיוטה `vfcopy/G003.md` | **חסום מדיה** · משבצת א׳ 7.9 16:00 / נפילה לשלישי 9.9 16:00 |
