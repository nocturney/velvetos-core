...
| VF-G004 | סטוריז / קרוסלה | קטלבל ורוד = מחזיק תכשיטים/טבעות לאימון (**לא** משקולת) | תיבת Grok `INSTA/media/kettlebells-pink-batch-2026-09-06-01…05.jpeg` + `…tops-print-end-2026-09-06.jpeg` | חסר טיוטה | **מועמד סטוריז/קרוסלה** · כרטיס `G004.md` |
| VF-G006 | קרוסלת פיד | מועמד G004 (אם כיתוב מוכן) | אותה תיבה | חסר | **חסום כיתוב** · חמישי 11.9 12:00 |
...
דופק 6.9: 80 עוקבים · רילס מביאים לא-עוקבים · DM 0 · לחזק היילייטס/וואטסאפ (`hq/FOLLOWER-GROWTH.md`).
