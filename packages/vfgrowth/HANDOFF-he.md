...
| CTA | **PUBLIC_CURRENT_CTA** — שלחו לנו הודעה כאן באינסטגרם · היילייטס · איסוף שדרות · **לא אוטו־DM** · לא וואטסאפ בכיתוב |
| מחיר | `X ₪` · בלי ₪ בפריים |
...
2. כיתוב נשאר `vfcopy/G003.md`. בלי ₪. בלי «שלחו DM». בלי `050-2517000` בכיתוב.
...
CTA: שלחו לנו הודעה כאן באינסטגרם · היילייטס בפרופיל · איסוף שדרות כהזמנה.  
...
- שיבוץ בלי ארטיפקט `preflight/<id>.md` עבור
- לשאול את כריסטיאן איזו משבצת / מתי לפרסם
- אל תפנה לכריסטיאן על מדדים חלשים / «רמה נמוכה» / נתיחת איכות אחרי פרסום
