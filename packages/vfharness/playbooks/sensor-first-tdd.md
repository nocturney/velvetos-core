...
רתמה: `vfharness` · אחרי: `verification-before-claim.md` · באג: `systematic-debugging.md` · ביצוע: `implementation-discipline.md`.
...
ל־prose/static config — אין test theater; ראה `implementation-discipline.md`.
...
| test theater ל־prose/config | `implementation-discipline.md` |

## קישורים

- `systematic-debugging.md` · `verification-before-claim.md` · `implementation-discipline.md` · `writing-plans.md` · `executing-plans.md` · `skill-first.md`
