...
Use when the user asks for רתמה, harness, AGENTS.md, checkpoint, escalate, or to harden a repeating agent failure.
...
Instagram/Gmail/WhatsApp send, invented ₪ or Insights, CrewAI/AutoGPT, LLM-as-judge as a gate for ILS or send, inventing a blocked source body.
