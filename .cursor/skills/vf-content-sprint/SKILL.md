...
21. Run `final_quality_gate` fail-closed. It may reject publication. PASS requires evidenced completion of saturation scan, anti-generic, format selection, hook tournament, retention, authority/voice, engagement and visual QA, plus Content Contract, final-copy pass, Visual OS, CONTENT-RUBRIC, rights, policy and publish preflight. Missing evidence is not PASS.
