...
8. **אין שינוי הרשאות שיתוף ציבורי** מ־HQ על מקור/נכנס/בעבודה. לא `anyone with the link` על הכספת. URL ציבורי זמני — **רק** לנגזרת מאושרת לפרסום (ראה סעיף 6 בנוהל).
