...
| **GrokBot** | הפעלת משרד, תוצרים, דיווח התנהגות בפועל — לפי הרשאות קיימות · **כספת מדיה:** Drive MCP על חמש התיקיות הנעולות |
...
נוהל: `docs/MEDIA-VAULT.md`. קטלוג אחד. העלאה ≠ אישור. תיקיית «מאושר לפרסום» לבד ≠ הוכחת אישור. **05 - פורסם** הוא שלב terminal לנגזרת המדויקת אחרי live verification בלבד; אחרי אימות מעבירים 04→05 ומעדכנים את אותה שורת קטלוג. לא מוחקים קבצים. לא ממציאים ₪ / מק״ט.
