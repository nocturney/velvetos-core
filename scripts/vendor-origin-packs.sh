...
vendor_one() {
  ...
  for keep in hq SKILL.md ROUTINE.md BRIEF.md DAILY.md GATE.md PATH.md DESK.md CALENDAR.md RHYTHM.md CHECKLIST.md FLOOR-CARD.md PICKUP.md SLICE.md QUOTE.md FLOOR.md MATERIAL.md CARDS.md LOCK.md CHAIN.md LEDGER.md PHONE.md REVIEW.md SKIP.md READ.md DRAFT.md CONNECT.md OPEN.md WORKFLOW.md FORMATS.json G003.md G005.md G006.md G005-d12b.md HANDOFF-he.md HANDOFF-STANDING-he.md LAB.md CARD.md BIO.md data; do
    if [[ -e "$dest/$keep" ]]; then
