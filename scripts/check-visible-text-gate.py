...
def main() -> None:
    require(
        ...
        ("כל טקסט", "כריסטיאן", "לקוח", "reader-first-he.md", "velvet-hebrew-copy", "ai-tells-he.md", "approved_static_copy", "visible_text_gate: PASS", "UNPROVEN"),
    )
    ...
    for needle in ("constitution/VISIBLE_TEXT.md", "owner-facing", "customer", "reader-first-he.md", "vf-hebrew-copy", "ai-tells-he.md", "UNPROVEN"):
        if needle not in rule:
            fail(f"always-on visible-text rule missing {needle!r}")

    require(
        "packages/vfcopy/SOFT-TOOLS-CONTRACT.md",
        ("human-visible AI text", "public-social", "customer-message", "sales-proposal", "owner-brief", "human-document", "ui-microcopy", "scripts/vf_visible_text.py", "text_sha256"),
    )
    require(
        "packages/vfcopy/skills/velvet-hebrew-copy/SKILL.md",
        ("לכל טקסט אנושי נראה", "customer-message", "sales-proposal", "owner-brief", "human-document", "ui-microcopy", "reader-first-he.md", "ai-tells-he.md", "visible_text_gate"),
    )
    require(
        "packages/vfcopy/skills/velvet-hebrew-copy/PIPELINE.md",
        ("PIPELINE — Visible Text Gate", "public-social", "visual-microcopy", "customer-message", "sales-proposal", "owner-brief", "human-document", "ui-microcopy", "UNPROVEN"),
    )
    require(
        ".cursor/skills/vf-hebrew-copy/SKILL.md",
        ("human-visible", "owner-brief", "customer-message", "sales-proposal", "human-document", "ui-microcopy", "visible_text_gate: PASS"),
    )
