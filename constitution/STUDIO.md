...
כיתוב `@velvets_cloud` = [`packages/vfcopy/VOICE.md`](../packages/vfcopy/VOICE.md).  
שני מצבים בלבד: **תהליך-קצר** (ריל חשיפה) או **סיפור-מוצר** (פריט גמור).  
נעול משני הפוסטים הראשונים בפיד — לא ממציאים. מחקר שכנים: `packages/vfcopy/VOICE-RESEARCH.md`.  
בלי ₪ בכיתוב. בלי פתיחה ב«מוכנים» / «בלי משלוח». בלי קופי דק כמו G004 המוקדם.
