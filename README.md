...
<tr><td><strong>Social Intelligence + Creative Learning</strong></td><td><strong>IMPLEMENTED / EVIDENCE-GATED</strong></td><td dir="rtl" align="right">מחקר ציבורי חיצוני מנורמל ל־SocialResearchPacket ו־Reference mechanics, עם provider-discovery מתוחזק ל־Reels, hashtags, Meta Ads Library ומעקב competitor/reference מצומצם; `watch-delta` משווה snapshots ציבוריים באופן דטרמיניסטי ו־null-safe. Instagram MCP נשאר מקור האמת לחשבון שלנו; אין virality score כללי, scraping פרטי, engagement automation, scheduler חדש או runtime מקביל.</td></tr>
...
<tr><td><strong>Social Intelligence + Creative Learning</strong></td><td><strong>IMPLEMENTED / EVIDENCE-GATED</strong></td><td>Public external research is normalized into SocialResearchPacket/reference mechanics, with maintained provider discovery for Reels, hashtags, Meta Ads Library and narrow competitor/reference monitoring; `watch-delta` compares bounded public snapshots deterministically with null-safe metrics. Instagram MCP remains canonical for our own account; there is no generic virality score, private scraping, engagement automation, new scheduler, or parallel runtime.</td></tr>
