...
| **Owner blocked** | 0 |
| **Degraded tools** | 0 |
| **Last verified / refreshed evidence** | `2026-09-11T09:37:20Z` |
...
<tr><td><strong>HyperFrames Video Backend</strong></td><td><strong>IMPLEMENTED / HOST-GATED</strong></td><td dir="rtl" align="right">מנוע קומפוזיציה ורינדור דטרמיניסטי ל־Reel/Story, motion ו־RTL בתוך ה־Visual Foundry; FFmpeg/SVG נשאר failover. הרצה חיה דורשת host מורשה עם HyperFrames 0.8.35 מותקן ומאומת.</td></tr>
...
<tr><td><strong>HyperFrames Video Backend</strong></td><td><strong>IMPLEMENTED / HOST-GATED</strong></td><td>Deterministic Reel/Story composition, motion and RTL rendering inside the existing Visual Foundry, with FFmpeg/SVG failover. Live execution requires an authorized host with verified HyperFrames 0.8.35.</td></tr>
