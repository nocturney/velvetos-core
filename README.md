...
<tr><td><strong>OpenPost Publishing Control Plane</strong></td><td><strong>REVIEWED / SHADOW / PRODUCTION BLOCKED</strong></td><td dir="rtl" align="right">שכבת publication operations בתוך `vfigos`, לא סמכות קריאייטיב ולא runtime שני. Upstream נבדק עד v4.34.2; baseline של staging נשאר v4.31.0 עד backup + migration/smoke. production חסום עד public HTTPS/provider OAuth ועד `velvet.delivery_approval.v1` חתום מה־issuer הייעודי; direct Instagram MCP אינו bypass.</td></tr>
...
<tr><td><strong>OpenPost Publishing Control Plane</strong></td><td><strong>REVIEWED / SHADOW / PRODUCTION BLOCKED</strong></td><td>Publication operations inside existing `vfigos`, not a creative authority or second runtime. Upstream is reviewed through v4.34.2; staging baseline remains v4.31.0 pending backup + migration/smoke. Production remains blocked on public HTTPS/provider OAuth and a signed `velvet.delivery_approval.v1` from the dedicated issuer; direct Instagram MCP is not a bypass.</td></tr>
