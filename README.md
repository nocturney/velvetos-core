...
<tr><td><strong>Instagram Delivery Approval</strong></td><td><strong>KEY_REGISTERED / NEEDS_OPERATOR_SETUP</strong></td><td dir="rtl" align="right">מפתח האימות הציבורי vf-da-2026-09 רשום; ערכי החתימה ומזהה המפתח נשמרים ב-Secret Manager בלבד. פריסת ה-issuer והאימות החי עדיין לא הוכחו.</td></tr>
...
<tr><td><strong>Instagram Delivery Approval</strong></td><td><strong>KEY_REGISTERED / NEEDS_OPERATOR_SETUP</strong></td><td>Public verification key vf-da-2026-09 is registered; signing material and key ID are stored only in Secret Manager. Issuer deployment and live verification are not yet proven.</td></tr>
