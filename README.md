...
| **Owner blocked** | 0 |
| **Degraded tools** | 0 |
| **Last verified / refreshed evidence** | `2026-09-15T16:18:48+03:00` |

<div dir="rtl"><strong>מה השתנה:</strong> Office Control Plane מוטמע · followups=1 · dead_letters=0</div>
<div dir="ltr"><strong>What changed:</strong> Office Control Plane מוטמע · followups=1 · dead_letters=0</div>

<div dir="rtl"><strong>שינוי הטמעה אחרון:</strong> 2026-09-15 — **VF creative cold-start fail-closed:** Project Authority 6.2 removes the stale vfcanva publication route; exact Creative Manifest production evidence must return `project_preflight: PASS` + `creat…</div>
<div dir="ltr"><strong>Latest implementation change:</strong> 2026-09-15 — **VF creative cold-start fail-closed:** Project Authority 6.2 removes the stale vfcanva publication route; exact Creative Manifest production evidence must return `project_preflight: PASS` + `creat…</div>
