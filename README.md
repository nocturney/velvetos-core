...
<div dir="rtl"><strong>שינוי הטמעה אחרון:</strong> 2026-09-19 ? **Project Authority 6.4 runtime binding:** removed active 6.2 hard-codes from Project preflight/publication-evidence gates and their regression sensor; active bundle paths, identity and canonical L…</div>
<div dir="ltr"><strong>Latest implementation change:</strong> 2026-09-19 ? **Project Authority 6.4 runtime binding:** removed active 6.2 hard-codes from Project preflight/publication-evidence gates and their regression sensor; active bundle paths, identity and canonical L…</div>
